...
//       <h1 className="header text-[#242424] text-[18px] px-4">Dashboard</h1>
//       <div className="flex justify-start items-stretch gap-4">
//         <input
//           type="text"
//           name="searchQuery"
//           id="searchQuery"
//           className="bg-[#E8E8E8] rounded-[5rem] border-none outline-none px-5 py-3 flex-1 text-xs"
//           placeholder="Search"
//         />
//         <button className="description font-bold text-xs rounded-[5rem] bg-[#242424] text-[#fff] px-5">
//           Add Teammate +
//         </button>
//         <button className="description font-bold text-xs rounded-[5rem] bg-[#242424] text-[#fff] px-5">
//           Manage Team
