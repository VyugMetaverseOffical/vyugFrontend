...
const ForgotPasswordOTPVerification = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Forgot Password OTP Verification - VYUG Metaverse</title>
        <meta
          name="description"
          content="Verify your OTP to reset your password on VYUG Metaverse."
        />
        <meta
          name="keywords"
          content="forgot password OTP Verification, OTP Verification"
        />
        <meta
          property="og:title"
          content="Forgot Password OTP Verification - VYUG Metaverse"
        />
        <meta
        ...
        <link
          rel="canonical"
          href="https://www.vyugmetaverse.com/auth/forgot/verify-otp"
        />
      </Helmet>
      <div
