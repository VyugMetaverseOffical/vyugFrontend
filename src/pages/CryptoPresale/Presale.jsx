...
const Presale2 = () => {
  ...
  return (
    <div style={{ height: "600px", overflow: "hidden" }}>
      <Parallax ref={parallaxRef} pages={8.6}>
        <ParallaxLayer
          offset={0}
          factor={3}
          style={{
        ...
        <ParallaxLayer sticky={{ start: 0, end: 2.15 }} speed={0.2}>
          <div className={`top-32 right-20 ml-auto absolute`}>
            <PreSaleTxn />
          </div>
        </ParallaxLayer>
        ...
        <ParallaxLayer offset={4.9} speed={0.2}>
          <div
        ...
        <ParallaxLayer offset={7.9} speed={0.2}>
          ...
          >
            ...
            <button
              ...
              } header mx-auto bg-[#D9D9D9] rounded-full`}
            >
              Explore Now
            </button>
          </div>
        </ParallaxLayer>
        {/* <ParallaxLayer offset={0} factor={1.2} speed={0.2}>
          <div
            className={`${
              isTab ? "w-[45%] right-[40px]" : "w-[40%] right-[60px]"
            } ${isTab2 ? "top-2" : isTab3 ? "top-0" : isTab1 ? "top-32" : isMac && "top-32"} ml-auto absolute`}
          >
            <PreSaleTxn />
          </div>
        </ParallaxLayer> */}
        <ParallaxLayer sticky={{ start: 0 , end: 3.4 }} speed={0.2}>
          <div
            className={`${
              isTab ? "w-[45%] right-[40px]" : "w-[40%] right-[60px]"
            } ${isTab2 ? "top-2" : isTab3 ? "top-0" : isTab1 ? "top-32" : isMac && "top-32"} ml-auto absolute`}
