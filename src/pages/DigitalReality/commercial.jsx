...
import video from "../../images/sector/Commercial/commerce.mp4";
import video1 from "../../images/sector/Commercial/commerceMobile.mp4";
import unmute from "../../images/unmute.svg";
import mute from "../../images/mute_hover.svg";
import sliderImg1 from "../../images/sector/Commercial/img1.webp";
import sliderImg2 from "../../images/sector/Commercial/img2.webp";
import sliderImg3 from "../../images/sector/Commercial/img3.webp";
...
import commercial from "../../images/commercialIcon.svg";
...
const Commercial = () => {
  ...
  const faqs = [
    {
      question: "What types of commercial spaces are available in VYUG?",
      answer:
        "VYUG offers virtual shops, malls, and marketplaces for businesses.",
    },
    {
      question: "Can I start an online store in VYUG?",
      answer:
        "Yes, you can set up and manage your virtual store within the VYUG marketplace.",
    },
    {
      question: "Are there opportunities for advertising?",
      answer:
        "VYUG provides various advertising options for businesses to promote their products and services.",
    },
    {
      question: "How do transactions work in VYUG?",
      answer:
        "Transactions in VYUG are facilitated through integrated payment systems, including cryptocurrencies.",
    },
    {
      question: "Is there support for international trade?",
      answer:
        "Yes, VYUG supports global trade, allowing businesses to reach international customers.",
    },
    {
      question: "Can I rent commercial space in VYUG?",
      answer:
        "Yes, commercial spaces can be rented on a short-term or long-term basis.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>VYUG Provide Best Virtual Reality System in Business</title>
        <meta name="description" content="VYUG Best Commercial Use VR System Provider Agency. Use VR technology creates a computer-generated environment for all Virtual Reality Business Application." />
        <meta name="keywords" content="Virtual Reality in Business, Virtual Reality Business, VR in Business, Commercial Use VR System" />
        <meta property="og:title" content="VYUG Provide Best Virtual Reality System in Business" />
        <meta property="og:description" content="VYUG Best Commercial Use VR System Provider Agency. Use VR technology creates a computer-generated environment for all Virtual Reality Business Application." />
        <link
          rel="canonical"
          href="https://www.vyugmetaverse.com/sectors/virtual-reality-in-commercial"
        />
      </Helmet>
      {loading && <Starter />}
      <div>
        ...
        >
          <div className="flex justify-center items-center gap-3 mb-1 md:mb-3">
            <img src={commercial} className="w-12 sm:w-16" alt="Commercial" />
            <h1 className="header font-medium text-[25px] md:text-[28px] text-[#6D6A6A]">
              {animationTriggered && (
                <TypeAnimation
                  sequence={["COMMERCIAL", 2000]}
                  wrapper="span"
                  speed={30}
                  repeat={0}
                  cursor={false}
          ...
          <p
            ...
            className="text-center text-[#6D6A6A] max-w-5xl text-sm md:text-base description mx-auto"
          >
            VYUG will create an innovative commercial landscape where businesses
            can establish virtual storefronts and engage with customers through
            personalized shopping experiences. Users can browse and purchase
            products in a fully interactive setting, with virtual try-ons and
            demonstrations enhancing the shopping journey
          </p>
        </Box>
        <Box
          className="relative"
        ...
        >
          ...
          <Box className="absolute z-[2] top-[55%] sm:top-1/2 md:top-2/3 left-10 sm:left-20 md:left-36 flex flex-col gap-2 md:gap-2.5">
            <p className="w-3/4 text-white text-lg sm:text-xl md:text-2xl text-start header">
              Discover a new dimension of shopping in a virtual marketplace that
              transcends reality
            </p>
          </Box>
        </Box>
