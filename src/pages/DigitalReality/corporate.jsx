...
import video from "../../images/sector/Corporate/corporate.mp4";
import video1 from "../../images/sector/Corporate/corporateMobile.mp4";
import unmute from "../../images/unmute.svg";
import mute from "../../images/mute_hover.svg";
import sliderImg1 from "../../images/sector/Corporate/img1.webp";
import sliderImg2 from "../../images/sector/Corporate/img2.webp";
import sliderImg3 from "../../images/sector/Corporate/img3.webp";
...
import corporate from "../../images/corporateIcon.svg";
...
const Corporate = () => {
  ...
  const faqs = [
    {
      question: "What corporate services does VYUG provide?",
      answer:
        "VYUG offers virtual office spaces, meeting rooms, and collaboration tools for businesses.",
    },
    {
      question: "Can companies hold virtual meetings in VYUG?",
      answer:
        "Yes, VYUG provides facilities for virtual meetings and conferences.",
    },
    {
      question: "Is it possible to rent office space in VYUG?",
      answer:
        "Yes, businesses can rent virtual office spaces tailored to their needs.",
    },
    {
      question: "Are there tools for remote collaboration?",
      answer:
        "VYUG includes a range of tools for remote work, including project management and communication platforms.",
    },
    {
      question: "Can businesses host virtual events in VYUG?",
      answer:
        "Yes, companies can host virtual events, product launches, and trade shows.",
    },
    {
      question: "How secure is the corporate data in VYUG?",
      answer:
        "VYUG ensures high-level security measures to protect corporate data and communications.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Corporate Work with Immersive VYUG Virtual Reality System</title>
        <meta name="description" content="VYUG Platform Provide Virtual Corporate Work Place. Our System Ways to Enhance the Experience of Corporate Employees, Including for Training and Marketing." />
        <meta name="keywords" content="Corporate Work With VR, Virtual Reality Corporate Training, Virtual Meeting" />
        <meta property="og:title" content="Corporate Work with Immersive VYUG Virtual Reality System" />
        <meta property="og:description" content="VYUG Platform Provide Virtual Corporate Work Place. Our System Ways to Enhance the Experience of Corporate Employees, Including for Training and Marketing." />
        <link
          rel="canonical"
          href="https://www.vyugmetaverse.com/sectors/virtual-reality-in-corporate"
        />
      </Helmet>
      {loading && <Starter />}
      <div>
        ...
        >
          ...
          <p
            ...
            className="text-center text-[#6D6A6A] max-w-5xl text-xs sm:text-sm md:text-base description mx-auto"
          >
            Corporate integration in VYUG will transform the way businesses
            operate. Virtual offices will enable remote collaboration, meetings,
            and training, fostering a new culture of productivity and
            creativity. Companies can host team-building events, workshops, and
            conferences, bringing employees together in a dynamic virtual
            environment
          </p>
        </Box>
        <Box
        ...
        >
          ...
          <Box className="absolute z-[2] top-[55%] sm:top-1/2 md:top-2/3 left-10 sm:left-20 md:left-36 flex flex-col gap-2 md:gap-2.5">
            <p className="w-3/4 text-white text-lg sm:text-xl md:text-2xl text-start header">
              Transforming workplaces into immersive virtual environments that
