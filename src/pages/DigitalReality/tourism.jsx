...
import video from "../../images/sector/Tourism/tourism.mp4";
import video1 from "../../images/sector/Tourism/tourismMobile.mp4";
import unmute from "../../images/unmute.svg";
import mute from "../../images/mute_hover.svg";
import sliderImg1 from "../../images/sector/Tourism/img1.webp";
import sliderImg2 from "../../images/sector/Tourism/img2.webp";
import sliderImg3 from "../../images/sector/Tourism/img3.webp";
...
import tourism from "../../images/tourismIcon.svg";
...
const Tourism = () => {
  ...
  const faqs = [
    {
      question: "What tourist attractions are in VYUG?",
      answer:
        "VYUG features virtual replicas of famous landmarks, heritage sites, and tourist destinations.",
    },
    {
      question: "Can I take virtual tours in VYUG?",
      answer: "Yes, guided virtual tours of various attractions are available.",
    },
    {
      question: "Are there interactive tourism experiences?",
      answer:
        "Yes, users can interact with the environment and learn about the history and culture of different places.",
    },
    {
      question: "How do I book a tour in VYUG?",
      answer: "Tours can be booked through the VYUG tourism section.",
    },
    {
      question: "Is there a cost for virtual tourism?",
      answer:
        "Some tours are free, while others may have a fee depending on the experience offered.",
    },
    {
      question: "Can I interact with other tourists in VYUG?",
      answer:
        "Yes, users can interact with other tourists and share their experiences.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Virtual Tourism in Metaverse : Vyug Metaverse Tourism</title>
        <meta name="description" content="Dive into the future of toursim with the VYUG Metaverse and explore your favorites tour spots in just using VR." />
        <meta name="keywords" content="Tourism" />
        <meta property="og:title" content="Virtual Tourism in Metaverse : Vyug Metaverse Tourism" />
        <meta property="og:description" content="Dive into the future of toursim with the VYUG Metaverse and explore your favorites tour spots in just using VR." />
        <link
          rel="canonical"
          href="https://www.vyugmetaverse.com/sectors/virtual-reality-in-tourism"
        />
      </Helmet>
      {loading && <Starter />}
      <div>
        ...
        >
          <div className="flex justify-center items-center gap-3 mb-1 md:mb-3">
            <img src={tourism} className="w-12 sm:w-16" alt="Tourism" />
            <h1 className="text-[#6D6A6A] font-medium header text-[25px] md:text-[28px]">
              {animationTriggered && (
                <TypeAnimation
                  sequence={["TOURISM", 2000]}
                  wrapper="span"
                  speed={30}
                  repeat={0}
                  cursor={false}
          ...
          >
            Traveling to new destinations will take on a whole new meaning in
            VYUG. Users can explore virtual replicas of famous landmarks,
            cultural heritage sites, and hidden gems from around the world.
            Guided tours and interactive experiences will make learning about
            different cultures accessible and engaging
          </p>
        </Box>
        <Box
          className="relative"
        ...
        >
          ...
          <Box className="absolute z-[2] top-[55%] sm:top-1/2 md:top-2/3 left-10 sm:left-20 md:left-36 flex flex-col gap-2 md:gap-2.5">
            <p className="w-3/4 text-white text-lg sm:text-xl md:text-2xl text-start header">
              Travel beyond borders in a virtual world that brings the wonders
              of the globe to your fingertips
            </p>
          </Box>
        </Box>
        <div
