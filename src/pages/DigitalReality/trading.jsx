...
import video from "../../images/sector/Sustainability/sustainability.mp4";
import video1 from "../../images/sector/Sustainability/sustainabilityMobile.mp4";
import unmute from "../../images/unmute.svg";
import mute from "../../images/mute_hover.svg";
import sliderImg1 from "../../images/sector/Sustainability/img1.webp";
import sliderImg2 from "../../images/sector/Sustainability/img2.webp";
import sliderImg3 from "../../images/sector/Sustainability/img3.webp";
...
import funpark from "../../images/funparkIcon.svg";
...
const Trading = () => {
  ...
  const faqs = [
    {
      question: "How does VYUG promote environmental sustainability?",
      answer:
        "VYUG reduces the need for physical travel by providing virtual environments for work, education, and entertainment, thereby lowering carbon emissions associated with transportation.",
    },
    {
      question: "What energy sources power the VYUG infrastructure?",
      answer:
        "VYUG is committed to using renewable energy sources to power its servers and infrastructure, aiming to minimize its carbon footprint and support sustainable energy practices.",
    },
    {
      question:
        "How are virtual events in VYUG more sustainable than physical events?",
      answer:
        "Virtual events in VYUG eliminate the need for physical venues, travel, and resource consumption, significantly reducing the environmental impact compared to traditional events.",
    },
    {
      question: "Can VYUG help businesses achieve their sustainability goals?",
      answer:
        "Yes, by operating in VYUG, businesses can reduce their environmental impact through virtual offices, meetings, and events, thus aligning with their sustainability objectives.",
    },
    {
      question: "How does VYUG address waste management in its virtual world?",
      answer:
        "While VYUG operates in a digital space, it emphasizes data efficiency and the use of environmentally friendly technologies to minimize electronic waste and energy consumption.",
    },
    {
      question:
        "What initiatives does VYUG have for raising awareness about sustainability?",
      answer:
        "VYUG hosts educational programs, events, and campaigns focused on sustainability, encouraging users to adopt environmentally friendly practices both in the virtual world and in their daily lives.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Sustainability - VYUG Metaverse</title>
        ...
        <link
          rel="canonical"
          href="https://www.vyugmetaverse.com/sectors/virtual-reality-in-sustainability"
        />
      </Helmet>
      {loading && <Starter />}
      <div>
        ...
        >
          ...
          <p
            ...
            className="text-center text-[#6D6A6A] max-w-[54rem] text-xs sm:text-sm md:text-base description mx-auto"
          >
            VYUG is committed to promoting sustainability through virtual
            initiatives. Users can participate in virtual clean-up drives,
            conservation projects, and sustainability workshops, raising
            awareness and fostering a sense of community around eco-friendly
            practices
          </p>
        </Box>
        <Box
        ...
        >
          ...
          <Box className="absolute z-[2] top-[55%] sm:top-1/2 md:top-2/3 left-10 sm:left-20 md:left-36 flex flex-col gap-2 md:gap-2.5">
            <p className="w-3/4 text-white text-lg sm:text-xl md:text-2xl text-start header">
              Building a greener future with virtual solutions that inspire
