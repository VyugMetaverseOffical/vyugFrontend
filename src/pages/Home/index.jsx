...
import myVideo1 from "../../videos/galaxyMobile.mp4";
...
import presaleIcon from "../../images/presale.svg";
...
import CryptoPresale from "../CryptoPresale";
...
const index = ({ isClicked, setIsClicked }) => {
  const [loaded, setLoaded] = useState(false);
  const [menuOpen, setMenuOpen] = useState(false);
  const [showBanner, setShowBanner] = useState(true);
  const [showHomePageLoaded, setShowHomePageLoaded] = useState(false);
  ...
  // useEffect(() => {
  //   const isBannerShown = sessionStorage.getItem("#@94509345@#isBannerShown");
  //   if (!isBannerShown) {
  //     setShowBanner(true);
  //   }
  // }, []);
  ...
  return (
    <div className="cursor-none min-h-screen overflow-x-hidden">
      <Helmet>
        <title>
          Vyug: Hyper-Realistic Metaverse & Virtual Reality Experiences
        </title>
        <meta
          name="description"
          content="Explore Vyug, The World's first largest Hyper-Realistic Metaverse and Virtual Reality. Experience next-gen digital experiences of Vyug Metaverse Platform."
        />
        <meta name="keywords" content="Home" />
        <meta
          property="og:title"
          content="Vyug: Hyper-Realistic Metaverse & Virtual Reality Experiences"
        />
        <meta
          property="og:description"
          content="Explore Vyug, The World's first largest Hyper-Realistic Metaverse and Virtual Reality. Experience next-gen digital experiences of Vyug Metaverse Platform."
        />
        <link rel="canonical" href="https://www.vyugmetaverse.com/" />
      </Helmet>
      {isClicked || menuOpen || showBanner ? <CustomCursor /> : <FrontCursor />}
      <SideIcon />
      {loaded && <Starter />}
      {showBanner && !isClicked && (
        <div className="banner-css overflow-scroll">
          <div
            onClick={closeBanner}
            className="fixed top-5 right-5 z-[99999999]"
          >
      ...
      >
        ...
        <img
          ...
          // onClick={toggleAudio}
          onClick={!showBanner && toggleAudio}
        ...
        <div className="absolute top-0 left-0 right-0 z-[18] flex justify-between items-center py-9 px-9 md:px-[7rem]">
          <div className="flex justify-between items-center gap-[0.5rem] md:gap-5">
            ...
            <button onClick={!showBanner && handleToggleMenu}>
              <img
                src={menuIcon}
          ...
          <div
            ...
            // onClick={() => navigate("/landing-page/login")}
            onClick={() => !showBanner && navigate("/crypto-presale")}
            className="flex cursor-pointer items-center gap-4"
          >
            <h6 className="header text-white text-[18px] sm:text-[22px] md:text-[27px]">
              PRESALE
            </h6>
        ...
        {/* {!menuOpen && (
          <div className="absolute z-[18] bottom-0 flex flex-col-reverse justify-start items-center md:items-start gap-4 pb-10 md:pb-[5rem] md:px-[10rem]">
            <SignUpForm />
            <div>
              <p className="description text-center md:text-start text-[15px] md:text-[20px] text-white px-10 md:px-0 max-w-lg mx-auto">
                Discover VYUG, The ultimate virtual reality experience! Navigate
                hyper-realistic worlds, expand your business, revolutionized
                living, and more.
              </p>
            </div>
          </div>
        ...
        {!menuOpen && (
          <div
            className="absolute top-0 bottom-0 left-0 right-0 z-[15]"
            style={{
              background:
