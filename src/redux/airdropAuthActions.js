...
export const loginAirdropUser = createAsyncThunk(
  "auth/loginUser",
  async (userData) => {
    try {
      const resp = await protectedApiPost("airdrop/login", userData);
      toast.success(
...
export const registerAirdropUser = createAsyncThunk(
  "auth/registerUser",
  async (userData) => {
    try {
      const resp = await protectedApiPost("airdrop/register", userData);
      toast.success(
